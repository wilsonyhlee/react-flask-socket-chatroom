...
var ChatRoom = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            "div",
            { className: "col-xs-3 height-100 br-dark bal phn" },
            React.createElement(
                "div",
                { className: "bg-dark font-light pal text-center" },
                "Chat Room #",
                index
            ),
            React.createElement(
                "div",
                { className: "bg-light" },
                React.createElement(MessageList, { messageList: this.state.messages }),
...
},{"./Input.react":2,"./MessageList.react":4,"react":161}],2:[function(require,module,exports){
"use strict";
...
var Message = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                "div",
                { className: "col-xs-3 pvl" },
                this.props.user
            ),
            React.createElement(
                "div",
                { className: "col-xs-9 pvl" },
                this.props.content
            )
        );
    }
...
var MessageList = React.createClass({
    ...
    render: function render() {
        var messages = this.props.messageList.map(function (m, i) {
            return React.createElement(Message, { user: m.user, content: m.content });
        });
...
},{"./Message.react":3,"react":161}],5:[function(require,module,exports){
'use strict';
...
},{"./ChatRoom/ChatRoom.react":1,"react":161}],6:[function(require,module,exports){
